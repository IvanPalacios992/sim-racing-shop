...
export function VideoModal({ isOpen, onClose }: VideoModalProps) {
  ...
  return (
    <>
      <button
        type="button"
        className="fixed inset-0 z-40 bg-black/90 cursor-default"
        tabIndex={-1}
        aria-label={t("title")}
        onClick={onClose}
      />
      ...
      >
        <div className="bg-carbon border border-graphite rounded-lg w-full max-w-3xl pointer-events-auto">
          {/* Header */}
          <div className="flex items-center justify-between px-6 py-4 border-b border-graphite">
            <div className="flex items-center gap-3">
              ...
              <h2
                ...
                className="text-lg font-bold text-pure-white"
              >
                {t("title")}
              </h2>
            </div>
