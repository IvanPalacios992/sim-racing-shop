...
│       └── admin.ts                # Tipos TypeScript (DTOs admin: categorías, componentes, productos, imágenes)
├── tests/
...
2. **`AdminLayout`**: Layout con sidebar de navegación con links a Categorías, Componentes y Productos.
...
**Estructura del sidebar**:
- Logo "SIMRACING**SHOP**" con link a home
- Navegación con iconos (Tag, Package, ShoppingCart de Lucide)
- Links: Categorías (`/admin/categorias`), Componentes (`/admin/componentes`), Productos (`/admin/productos`)
