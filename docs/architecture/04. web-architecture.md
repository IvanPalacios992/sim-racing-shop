...
├── /{locale}/private-area/settings  → Configuraciones de usuario (requiere autenticación)
│
...
#### Configuraciones de Usuario (`/{locale}/private-area/settings`)

| Propiedad | Valor |
|-----------|-------|
| Ruta | `src/app/[locale]/private-area/settings/page.tsx` |
