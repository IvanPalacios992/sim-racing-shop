...
│   │   │   ├── admin-categories.ts # Funciones de API admin de categorías
│   │   │   ├── admin-components.ts # Funciones de API admin de componentes
│   │   │   └── admin-products.ts   # Funciones de API admin de productos + component-options
│   │   └── validations/
...
│       └── admin.ts                # Tipos TypeScript (DTOs admin: categorías, componentes, productos)
├── tests/
